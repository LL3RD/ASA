...
def main():
    ...
    parser.add_argument("--network_trainer", default='nnFormerTrainerV2_MEDIUMVIT_MAE', )
    parser.add_argument("--task", default='999', help="can be task name or task id")
    parser.add_argument("--fold", default=0, help='0, 1, ..., 5 or \'all\'')
    parser.add_argument('--tag', default='DEBUG', help='model tag.')
    ...
    trainer_class = get_default_configuration(network, task, network_trainer, plans_identifier, tag=args.tag)
    ...
    if network == "3d_cascade_fullres":
        ...
        assert issubclass(trainer_class,
                          nnFormerTrainer) or issubclass(trainer_class,
                                                         nnFormerTrainer_synapse), "network_trainer was found but is " \
                                                                                   "not derived from nnFormerTrainer "
