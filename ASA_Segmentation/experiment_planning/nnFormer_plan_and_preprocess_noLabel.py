...
from nnformer.experiment_planning.DatasetAnalyzer import DatasetAnalyzer_nolabel
from nnformer.experiment_planning.utils import crop_nolabel
...
def main():
    ...
    parser.add_argument("-t", "--task_ids", default=[888], nargs="+", help="List of integers belonging to the task ids you wish to run"
                                                            " experiment planning and preprocessing for. Each of these "
                                                            "ids must, have a matching folder 'TaskXXX_' in the raw "
                                                            "data folder")
    parser.add_argument("-pl3d", "--planner3d", type=str, default="ExperimentPlanner3D_v21_nolabel",
    ...
    for i in task_ids:
        ...
        crop_nolabel(task_name, False, tf)
    ...
    for t in tasks:
        ...
        dataset_analyzer = DatasetAnalyzer_nolabel(cropped_out_dir, overwrite=False, num_processes=tf)  # this class creates the fingerprint
