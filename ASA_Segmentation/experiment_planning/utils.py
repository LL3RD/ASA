...
from nnformer.preprocessing.cropping import ImageCropper, ImageCropper_nolable
...
def create_lists_from_splitted_dataset_nolabel(base_folder_splitted):
    lists = []
...
def crop_nolabel(task_string, override=False, num_threads=default_num_threads):
    ...
    lists, _ = create_lists_from_splitted_dataset_nolabel(splitted_4d_output_dir_task)

    imgcrop = ImageCropper_nolable(num_threads, cropped_out_dir)
