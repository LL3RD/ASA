...
from nnformer.paths import default_plans_identifier, network_training_output_dir, default_cascade_trainer, \
    default_trainer
...
def main():
    ...
    parser.add_argument("-i", '--input_folder',
                        default='/data2/huangjunjia/nnFormer/nnFormer_raw/nnFormer_raw_data/Task555_WMH/imagesTs/',
                        help="Must contain all modalities for each patient in the correct"
                             " order (same as training). Files must be named "
                             "CASENAME_XXXX.nii.gz where XXXX is the modality "
                             "identifier (0000, 0001, etc)")
    parser.add_argument('-o', "--output_folder",
                        default='/data2/huangjunjia/nnFormer/nnFormer_trained_models/nnFormer/3d_fullres/Task555_WMH/Paper/infers/nnFormer',
                        help="folder for saving predictions")
    parser.add_argument('-t', '--task_name', default='555', help='task name or task ID, required.')
    parser.add_argument('--tag', default='nnFormer', help='model tag.')
    parser.add_argument('-tr', '--trainer_class_name', default='nnFormerTrainerV2_WMH',
                        help='Name of the nnFormerTrainer used for 2D U-Net, full resolution 3D U-Net and low '
                             'resolution '
    ...
    model_folder_name = join(network_training_output_dir, model, task_name, "Paper", trainer + "__" +
                             args.tag)
