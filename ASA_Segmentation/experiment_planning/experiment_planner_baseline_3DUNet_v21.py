...
from nnformer.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner, ExperimentPlanner_nolabel
...
class ExperimentPlanner3D_v21_nolabel(ExperimentPlanner_nolabel):
    """
    Combines ExperimentPlannerPoolBasedOnSpacing and ExperimentPlannerTargetSpacingForAnisoAxis
    ...
    """
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_v21_nolabel, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnFormerData_plans_v2.1"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnFormerPlansv2.1_plans_3D.pkl")
        self.unet_base_num_features = 32
