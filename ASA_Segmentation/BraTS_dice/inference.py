...
def main():
    folder_pred = '/data2/huangjunjia/nnFormer/nnFormer_trained_models/nnFormer/3d_fullres/Task999_BraTS2021/Paper/Infers/DEBUG/'
    evaluate_BraTS_folder(folder_pred,
                          '/data2/huangjunjia/nnFormer/nnFormer_raw/nnFormer_raw_data/Task999_BraTS2021/labelsTs')
